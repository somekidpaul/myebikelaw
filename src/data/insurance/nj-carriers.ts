...
export const NJ_CARRIERS: ReadonlyArray<CarrierEntry> = [
  {
    ...
    oneLiner:
      "The only carrier with an NJ-specific S4834 liability page, and in July 2026 it added a liability-only option built for this law. Its page states the requirement as $15k/$30k/$5k, which matches the regulation. Still ask them to confirm your limits and the pedestrian PIP in writing when you quote.",
    jurisdictions: ['NJ'],
