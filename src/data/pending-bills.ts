...
export const PENDING_STATE_BILLS: ReadonlyArray<PendingStateBill> = [
  ...
  },
  {
    ...
    oneLiner:
      "Does NOT add license, registration, or insurance for e-bikes. Utah keeps the Class 1/2/3 (≤750W) framework, expressly excludes an 'electric assisted bicycle' from the 'motor vehicle' definition, and its driver-licensing statute says outright that an e-bike rider needs no class D driver license and no motorcycle endorsement (from May 5, 2027 it adds that a rider 16 or older also needs no safety certificate). Only reclassified 'high power electric devices' and 'electric motorcycles' (over 750W, or capable of over 20 mph on the motor alone) are treated like motorcycles under Utah's traffic code, and even then a high power electric device without a VIN that is not a motorcycle is exempt from liability insurance. What HB 381 does add for ordinary e-bike riders is safety rules, not vehicle paperwork: a helmet under 21 on highways and a ban on riding while drinking (both in effect now), and from May 5, 2027 a minimum age of 8 to ride on a highway plus a rule that riders under 16 either earn a safety certificate (online, fee capped at $10) or ride under direct adult supervision.",
    details:
      "House Bill 381 (Electric Mobility Device Amendments; 3rd Sub., sponsor Rep. Cutler) was signed by Governor Cox on March 24, 2026; most of its e-bike provisions took effect May 6, 2026, but FOUR sections carry a later date of May 5, 2027: Sec. 41-6a-1115 (motor assisted scooters), Sec. 41-6a-1115.5 (electric assisted bicycle restrictions), new Sec. 41-6a-1512 (the safety-certificate program), and Sec. 53-3-202 (the 'Drivers shall be licensed' statute). Reading the enrolled text: an 'electric assisted bicycle' is a bike with a motor ≤750W, fully operable pedals, and Class 1/2/3 (or programmable) behavior (Sec. 41-6a-102(21)), and it is expressly EXCLUDED from the traffic code's 'motor vehicle' definition (Sec. 41-6a-102(51)(b)(iv)). The paperwork exemptions sit in separate, existing statutes: an electric assisted bicycle is exempt from registration (Sec. 41-1a-202(2)(a)(xiv)) and from the owner's or operator's security (insurance) requirement (Sec. 41-12a-301(5)(c)), and an individual operating one is not required to have a class D driver license or a motorcycle endorsement (Sec. 53-3-202, in the version in force now). HB 381 instead creates two reclassified device types: an 'electric motorcycle' (a motorcycle over 750W or capable of exceeding 20 mph on motor power alone, Sec. 41-6a-102(23)) and a 'high power electric device' (a self-propelled vehicle capable of over 20 mph on motor power alone — including an e-bike modified/tampered beyond its factory settings, Sec. 41-6a-102(32)). Under new Sec. 41-6a-1511(1)(a), an individual operating a high power electric device, including an electric motorcycle, 'has all rights and is subject to all provisions of this chapter applicable to an operator of a motorcycle'. That chapter is Utah's traffic code; registration, licensing, and insurance are governed by other titles. Sec. 41-6a-1511(1)(b) adds that a high power electric device without a vehicle identification number that is not a motorcycle is not subject to the liability insurance requirement of Sec. 41-12a-301, and from May 5, 2027 a rider 16 or older may operate a high power electric device on a highway with a class D driver license (Sec. 53-3-202(5)(d)). The new mandates that touch an ordinary e-bike rider are all safety rules, never vehicle paperwork, and they fall on two different dates. In effect since May 6, 2026: a helmet for any rider under 21 operating on a highway (Sec. 41-6a-1505(1)(b), broadened from the old class-3-only rule, and it does not apply to a rented class 1 e-bike or motor assisted scooter, Sec. 41-6a-1505(3)), and a prohibition on consuming alcohol while operating any electric assisted bicycle. Effective May 5, 2027: a 'personal electric vehicle safety certificate' program (new Sec. 41-6a-1512), under which a rider eight or older and under 16 may not operate an electric assisted bicycle with the motor engaged on a highway unless the rider either obtains that certificate or is under the direct supervision of a parent or another responsible adult (Sec. 41-6a-1115.5(4) and, in identical terms, Sec. 53-3-202(5)(b)); a rider under eight may not operate one on a highway at all (Sec. 41-6a-1115.5(6)); and a rider under 16 may not use a freeway (Sec. 41-6a-1512(5)). The certificate is administered by the department, must be completable online, and carries a fee of $10 or less; violating the section is an infraction capped at $150. Note this REPLACED a narrower prior rule that required supervision only under age 14, so it is a real tightening. Crucially, it is not a licensing requirement: Sec. 53-3-202(5)(b)(i) states that an under-16 rider 'is not required to hold a class D driver license or a motorcycle endorsement' for an e-bike, and Sec. 53-3-202(5)(c) states that a rider 16 or older may ride 'without' a class D driver license, a motorcycle endorsement, OR a safety certificate. There is also a point-of-sale disclosure (from Jan 1, 2027, Sec. 41-6a-1511(6)(a)) that an electric vehicle with fewer than four wheels which is NOT an electric assisted bicycle is instead a type of motor vehicle, subject to applicable motor vehicle laws if used on public roads or public lands. Same shape as Florida, Illinois, and Washington: the vehicle requirements attach only to higher-powered/reclassified devices, not to normal e-bikes — worth correcting the record on (law-firm and retailer blogs frame HB 381 as a license/registration change), but not a new e-bike compliance mandate, so it is tracked as informational rather than a compliance checker.",
    requirementHints: [],
