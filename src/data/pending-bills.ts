...
export const PENDING_STATE_BILLS: ReadonlyArray<PendingStateBill> = [
  ...
  // its own checker card on the splash page.
  {
    ...
    details:
      "The e-bike framework first rode on SB 3336 (Sen. Ram Villivalam; championed by Secretary of State Alexi Giannoulias), which passed the Senate 54-0 on April 15, 2026 and the House 80-30 on May 27, 2026 — but it stalled at Senate concurrence: it was calendared for a concurrence vote on House Amendments 2 & 3 on May 29, 2026 and that vote was never recorded, leaving SB 3336 dead for the session. The final language was instead carried by SB 3484 ('VEH CD-PLATES-REGISTRATION'), which adopted House Floor Amendment No. 1 and passed BOTH chambers on June 1, 2026 (House 84-16; Senate concurred 48-7). It now awaits Governor Pritzker; per the bill text it takes effect January 1, 2027 if signed. As of August 26, 2026 the General Assembly's own bill-status record for SB 3484 still gives 'Sent to the Governor' (June 30, 2026) as the last action, with no Public Act number and no veto. That record is current rather than merely unrefreshed: the General Assembly's published Public Acts kept growing while SB 3484's file sat still. Public Act 104-0853 (SB 3086) was published on August 25, 2026, and the batch approved on August 21, 2026 was published in ascending bill-number order and skipped SB 3484, which falls between SB 3465 (Public Act 104-0850) and SB 3707 (Public Act 104-0851). SB 3484's own status file has not been rewritten since July 1, 2026, the day after it went to the Governor. The bill was presented on June 30, 2026, and under Article IV, Section 9 of the Illinois Constitution 'any bill not returned by the Governor within 60 calendar days after it is presented to him shall become law.' Absent a veto it therefore becomes law on or before August 29, 2026, with or without a signature. Either way the scope below is unchanged. News aggregators are still misreporting this as an e-bike license/insurance mandate — the actual ILGA text does NOT impose a driver's license, certificate of title, registration, or insurance on low-speed electric bicycles (Class 1/2/3, motor <750W, assist capped at 20 or 28 mph). SB 3484 excludes low-speed electric bicycles from the 'motor vehicle' definition (Sec. 1-146) and treats them as bicycles (Sec. 11-1517(a)); only an electric bicycle that is NOT a low-speed electric bicycle becomes a 'motor-driven cycle' (Sec. 1-140.10), i.e. an electric motor over 750W (up to 8,000W) or a device capable of exceeding 28 mph — and those already require title/registration/license under existing Illinois law. Same shape as Florida's bill: worth correcting the record on, but not a new e-bike compliance mandate.",
    requirementHints: [],
