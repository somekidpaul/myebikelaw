...
- The "last reviewed" date in the footer is **hardcoded** ("May 21, 2026", bumped from May 14 after the 2026-05-21 re-verification) — a manual editorial date (when the statutes were actually reviewed), NOT auto-"today". Only bump when the law is genuinely re-reviewed. Carrier "Last verified" dates are separate (still May 14 — bump only when carriers are re-checked).
